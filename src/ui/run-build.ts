...
export function createRunBuildSummary(world: World): RunBuildSummaryV1 {
  ...
  return {
    ...
    meta: {
      ...
      damageMultiplier: world.runConfig.meta.damageMultiplier,
      cooldownMultiplier: world.runConfig.meta.cooldownMultiplier,
      damageTakenMultiplier: world.runConfig.meta.damageTakenMultiplier,
      pickupRadiusMultiplier: world.runConfig.meta.pickupRadiusMultiplier,
      healingMultiplier: world.runConfig.meta.healingMultiplier,
      xpMultiplier: world.runConfig.meta.xpMultiplier,
      rerolls: world.runConfig.meta.rerolls,
