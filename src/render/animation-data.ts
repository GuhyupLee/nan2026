...
> = {
  ranged: {
    ...
    // Q — line up both hands into a narrow channel and punch a piercing ray through.
    q: motion(
      'ranged',
      'q',
      {
        ...
        rotations: {
          ...
          chest: [-0.1, -0.48, 0.11],
          head: [-0.09, 0.36, -0.07],
          leftUpperArm: [0.08, -0.48, -0.52],
          leftLowerArm: [-0.3, -1.08, -0.34],
          leftHand: [0.36, -0.44, 0.24],
          rightUpperArm: [0.16, 0.5, 0.46],
          rightLowerArm: [-0.34, 1.12, 0.36],
          rightHand: [-0.38, 0.48, -0.26],
          leftUpperLeg: [-0.32, 0.2, -0.18],
          leftLowerLeg: [0.52, -0.11, 0.12],
          leftFoot: [-0.25, -0.15, 0.09],
          rightUpperLeg: [0.26, -0.19, 0.16],
          rightLowerLeg: [0.41, 0.1, -0.1],
      ...
      },
      {
        ...
        rotations: {
          hips: [-0.09, -0.36, 0.13],
          spine: [-0.13, 0.5, -0.18],
          chest: [0.11, 0.58, -0.14],
          head: [0.06, -0.43, 0.09],
          leftUpperArm: [-1.16, 0.08, -0.24],
          leftLowerArm: [-0.12, -0.2, 0.14],
          leftHand: [-0.1, 0.22, 0.34],
          rightUpperArm: [-1.2, -0.08, 0.22],
          rightLowerArm: [-0.14, 0.22, -0.13],
          rightHand: [0.12, -0.24, -0.33],
          leftUpperLeg: [-0.46, 0.24, -0.22],
          leftLowerLeg: [0.68, -0.14, 0.15],
          leftFoot: [-0.31, -0.18, 0.12],
          rightUpperLeg: [0.38, -0.23, 0.2],
          rightLowerLeg: [0.54, 0.13, -0.13],
          rightFoot: [-0.27, 0.17, -0.11],
        },
      },
      {
        hipsY: 0.97,
        rotations: {
          hips: [0.05, -0.22, 0.075],
          spine: [0.08, 0.3, -0.1],
          chest: [-0.04, 0.36, -0.08],
          head: [-0.045, -0.26, 0.055],
          leftUpperArm: [-0.72, 0.02, -0.56],
          leftLowerArm: [-0.2, -0.4, 0.06],
          leftHand: [-0.04, 0.1, 0.2],
          rightUpperArm: [-0.75, -0.025, 0.53],
          rightLowerArm: [-0.21, 0.42, -0.055],
          rightHand: [0.05, -0.11, -0.19],
          leftUpperLeg: [-0.27, 0.16, -0.14],
          leftLowerLeg: [0.43, -0.09, 0.09],
          leftFoot: [-0.2, -0.12, 0.07],
          rightUpperLeg: [0.22, -0.15, 0.13],
          rightLowerLeg: [0.34, 0.085, -0.08],
          rightFoot: [-0.17, 0.11, -0.065],
        },
      },
    ),
